// ============================================
// POST /api/source/process/dna-compression — DNA 压缩
// ============================================
...
export async function POST(req: Request) {
  try {
    ...
    if (!userMessage) {
      return new Response(JSON.stringify({ error: '缺少分析报告内容' }), { status: 400 });
    }
    ...
    const message = error instanceof Error ? error.message : 'DNA 压缩失败';
    console.error('DNA 压缩错误:', error);
